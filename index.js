...
function getSort(a, b, num){
  if(roles[num] == '뜻'){
    if(a[num].split(/, |; /).some(el => el.split(')')[1] == t || el.split(') ')[1] == t || el.split('(')[0] == t || el.split(' (')[0] == t || el.split(' ¶')[0] == t)){
      return -1;
    }
    if(b[num].split(/, |; /).some(el => el.split(')')[1] == t || el.split(') ')[1] == t || el.split('(')[0] == t || el.split(' (')[0] == t || el.split(' ¶')[0] == t)){
      return 1;
    }
